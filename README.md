...
本仓库对应四份交付物。全部文件位于 [handoff-20260910 Release](https://github.com/Justpy-11/a2ui-3b-handoff-20260910/releases/tag/handoff-20260910)；03 完整工程因体积较大，以 8 个无损分片发布。Git 历史只保存说明、清单、校验值和重组脚本，避免把大型二进制写入普通 Git。
...
| 03 | `03-完整工程项目.zip` | `03-complete-project.zip.part01`—`part08` | 14,199,189,877 B | `b721a3cf0ffa80060e484c792fd6052724b56eac381e75446d85f9a1f7993a95` |
...
Release 共 11 个附件：01、02、04 各一个，03 为 `part01` 至 `part08`。GitHub 会规范化中文附件名，因此发布名采用稳定的英文 ASCII；原始中文名称、发布名称、大小和 SHA256 的对应关系以 [`release-manifest.json`](release-manifest.json) 为准。
