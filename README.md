...
本仓库对应四份交付物。当前 [handoff-20260910 Release](https://github.com/Justpy-11/a2ui-3b-handoff-20260910/releases/tag/handoff-20260910) 已发布 01、02、04；03 完整工程按交接安排暂缓上传，仍保留在本地交接包中。Git 历史只保存说明、清单、校验值和重组脚本，避免把大型二进制写入普通 Git。
